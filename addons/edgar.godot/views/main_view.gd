...
@onready var layers_scroll: ScrollContainer = %LayersScroll
...
func _apply_theme() -> void:
	...
	if is_instance_valid(layers_scroll):
		layers_scroll.add_theme_stylebox_override("panel", get_theme_stylebox("panel", "Panel"))
